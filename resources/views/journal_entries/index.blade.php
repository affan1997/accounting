...
<body>
    <div class="container p-5" id="main_container">
        ...
        @endif --}}
        <button class="btn btn-sm btn-dark" id="add_journal_entry_button" data-bs-toggle="modal" data-bs-target="#add_journal_entry_modal">Add Journal Entry</button>
        <livewire:journal_entries.create/>
        <livewire:journal_entries.index/>
